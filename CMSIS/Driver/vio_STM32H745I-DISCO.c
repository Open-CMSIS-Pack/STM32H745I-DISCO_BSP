...
| vioLED0       | vioSignalOut.0 | LED red     (LD6)    | PI13
| vioLED1       | vioSignalOut.1 | LED green   (LD7)    | PJ2
*/
...
//  signal,     pin,                   pull resistor,      active state
  { vioLED0,    GPIO_PIN_ID_PORTI(13), ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW },
  { vioLED1,    GPIO_PIN_ID_PORTJ(2),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW }
};
#endif
